...
console.log(eyeColor);
 ...
 let n = 0
 let crewMass = 0
  while (starWarsCharacters[n]) {
      crewMass += Number(starWarsCharacters[n].mass); n++
  }
  console.log("The total crew mass is " + crewMass)
...
const robotCharcters = []

for(i =0; i < starWarsCharacters.length; i++){
   if(starWarsCharacters[i].gender === "robot"){
       robotCharcters.push(starWarsCharacters[i])
   }
}
console.log(robotCharcters);
  ...
  */
    ...
    let randomCharcater = []
     ...
     randomCharcater.push(starWarsCharacters[Math.floor(Math.random()*starWarsCharacters.length)])
    

    console.log(randomCharcater)
